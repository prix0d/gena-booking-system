...
public class DayEntryViewSkin extends impl.com.calendarfx.view.DayEntryViewSkin {
    ...
    public DayEntryViewSkin(DayEntryView view) {
        ...
        var participants = FXCollections.observableArrayList(meet.participants);
        ...
        participants.addListener((ListChangeListener<? super String>) c -> {
    ...
    private ArrayList<Label> createParticipantLabels(ObservableList<String> participants) {
    ...
    protected Label createParticipantLabel(String participant) {
        var label = new Label("• " + participant);
